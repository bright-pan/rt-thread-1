...
#if defined(__ICCARM__) || defined(__ICCRX__) || defined(__ICCRL78__)/* for IAR compiler */
...
#endif
#elif defined (__ICCARM__) || defined(__ICCRX__) || defined(__ICCRL78__)      /* for IAR Compiler */
